...
def main():
    # по заданию данные необходимо брать из excel файла, но встретил проблему
    # с конвертацией дат рождения. В принципе понял как решить проблему, но не
    # укладываюсь уже по срокам. Поэтому пока, работу скрипта можно посмотреть
    # указывая данные в переменной example
    example = [
